...
namespace ns
{
  ...
  public:
    ...
    {
      llvm::BasicBlock* LoopCond = llvm::BasicBlock::Create(M->getContext(), "loop_cond", MainFn);
      llvm::BasicBlock* LoopBody = llvm::BasicBlock::Create(M->getContext(), "loop_body", MainFn);
      llvm::BasicBlock* AfterLoop = llvm::BasicBlock::Create(M->getContext(), "after_loop", MainFn);
